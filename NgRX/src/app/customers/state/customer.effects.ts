...
export class CustomerEffect {
  ...
  @Effect()
  public loadCustomers$: Observable<Action> = this.actions$.pipe(
  ...
  @Effect()
  public loadCustomer$: Observable<Action> = this.actions$.pipe(
  ...
  @Effect()
  public createCustomer$: Observable<Action> = this.actions$.pipe(
  ...
  @Effect()
  public updateCustomer$: Observable<Action> = this.actions$.pipe(
  ...
  @Effect()
  public deleteCustomer$: Observable<Action> = this.actions$.pipe(
